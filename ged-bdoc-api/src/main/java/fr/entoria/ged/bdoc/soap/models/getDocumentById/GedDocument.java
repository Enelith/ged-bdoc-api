...
/**
 * <p>Classe Java pour GedDocument complex type.
 * 
 ...
 *         &lt;element name="metainfo" type="{http://xml.apache.org/xml-soap}Map"/&gt;
...
@XmlType(name = "GedDocument", propOrder = {
    "author",
    "content",
    "creationDate",
    "id",
...
public class GedDocument {
    ...
    /**
     * Obtient la valeur de la propriété metainfo.
     * 
     * @return
     *     possible object is
     *     {@link Map }
    ...
    /**
     * Définit la valeur de la propriété metainfo.
     * 
     * @param value
     *     allowed object is
     *     {@link Map }
     *     
     */
    public void setMetainfo(Map value) {
        this.metainfo = value;
    }
