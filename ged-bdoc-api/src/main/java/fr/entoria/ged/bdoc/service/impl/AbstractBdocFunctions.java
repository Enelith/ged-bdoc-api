...
@Component
public abstract class AbstractBdocFunctions implements IBdocFunctions {
    private static final String LOGGER_HEADER = "[" + AbstractBdocFunctions.class.getName() + "] ";
    private static final Logger logger = (Logger) LoggerFactory.getLogger(AbstractBdocFunctions.class);
